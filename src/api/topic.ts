import { TopicApi, ApiResponse, PaginationData } from '@/types/api'
...
export const topicApi = {
   ...
   */
  async getTopicList(
    params: TopicApi.GetTopicListReq
  ): Promise<ApiResponse<TopicApi.GetTopicListResp>> {
  ...
  async getTopicDetail(
    params: TopicApi.GetTopicDetailReq
  ): Promise<ApiResponse<TopicApi.GetTopicDetailResp>> {
   ...
   * @param params 请求参数
   */
  async getTopicLogList(
    params: TopicApi.GetTopicLogListReq
  ): Promise<ApiResponse<TopicApi.GetTopicLogListResp>> {
   ...
   * @param params 请求参数
   */
  async getTopicLogDetail(
    params: TopicApi.GetTopicLogDetailReq
  ): Promise<ApiResponse<TopicApi.GetTopicLogDetailResp>> {
   ...
   * @param data 请求数据
   */
  async createTopicLog(
    data: TopicApi.CreateTopicLogReq
  ): Promise<ApiResponse<TopicApi.CreateTopicLogResp>> {
   ...
   * @param data 请求数据
   */
  async updateTopicLog(
    data: TopicApi.UpdateTopicLogReq
  ): Promise<ApiResponse<TopicApi.UpdateTopicLogResp>> {
   ...
   * @param data 请求数据
   */
  async deleteTopicLog(
    data: TopicApi.DeleteTopicLogReq
  ): Promise<ApiResponse<TopicApi.DeleteTopicLogResp>> {
